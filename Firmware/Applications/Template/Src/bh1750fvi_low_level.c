...
{
    printf("I2C write: addr=0x%02X, cmd=0x%02X\n",device_address, command);
    HAL_I2C_MasterTransmit_Polling(&hi2c0,device_address,&command,1);
    printf("done\n");
}
...
{
    HAL_I2C_MasterReceive_Polling(&hi2c0,device_address,data_array,2);
}
